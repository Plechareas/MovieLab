...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 18, 2022 at 03:45 PM
...
CREATE TABLE `booked` (
  `id` int(11) NOT NULL,
  `costumer_username` varchar(50) NOT NULL,
...
INSERT INTO `booked` (`id`, `costumer_username`, `room`, `date`, `time`, `tickets`) VALUES
(1, 'test2', 'Dolby Atmos', '19-01-2022', '16:00', 1);

-- --------------------------------------------------------

--
-- Table structure for table `comingup`
--
...
--
-- Dumping data for table `comingup`
--
...
--
-- Table structure for table `playingnow`
--
...
--
-- Dumping data for table `playingnow`
--
...
--
-- Indexes for table `comingup`
--
ALTER TABLE `comingup`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `playingnow`
--
...
--
-- AUTO_INCREMENT for table `comingup`
--
ALTER TABLE `comingup`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `playingnow`
--
ALTER TABLE `playingnow`
